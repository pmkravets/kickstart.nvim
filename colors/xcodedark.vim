...
let s:t_Co = 256 "exists('&t_Co') && !empty(&t_Co) && &t_Co > 1 ? &t_Co : 2
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi Normal guifg=#dfdfe0 guibg=NONE guisp=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi Ignore ctermfg=59 ctermbg=NONE cterm=NONE guibg=NONE
